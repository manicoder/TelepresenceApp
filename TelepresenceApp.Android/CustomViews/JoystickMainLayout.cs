...
namespace GCoreApp.Droid.CustomViews
{
    public class JoystickMainLayout : LinearLayout, View.IOnTouchListener
    {
        ...
        private readonly int _resolution = Convert.ToInt32(Xamarin.Essentials.DeviceDisplay.MainDisplayInfo.Width / 2)-147;
        ...
        private void SetContent(Context context)
        {
            ...
            var w = Convert.ToInt32(Xamarin.Essentials.DeviceDisplay.MainDisplayInfo.Width);
            var h = Convert.ToInt32(Xamarin.Essentials.DeviceDisplay.MainDisplayInfo.Height);
